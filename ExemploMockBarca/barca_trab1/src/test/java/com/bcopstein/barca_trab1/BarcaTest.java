...
public class BarcaTest {
    ...
    @ParameterizedTest
    @CsvSource({
        "'X10B20',   -1.0",  // fileira com 1 dígito
    ...
    //distribuição de peso primeiros 100 passageiros (fileiras 1 a 20)
    @Test
    ...
    //distribuição de peso entre 100 e 199 passageiros (fileiras 40 a 60)
    @Test
    ...
    //distribuição de peso após 200 passageiros (qualquer assento permitido)
    @Test
    ...
    //preço da passagem com base no horário
    @ParameterizedTest
    @CsvSource({
